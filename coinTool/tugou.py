...
COIN_API_URL = "https://api.dex.guru/v1/tradingview/history?symbol={}&resolution=1&from={}&to={}&currencyCode=USD"
...
NEWINU = "0x1997830b5beb723f5089bb8fc38766d419a0444d_USD"
...
def post_ifttt_webhook(event, value1, value2):
    env =  " ⚜️" if len(sys.argv) > 1 else ""
    msg = value1 + datetime.now().strftime("%m-%d %H:%M:%S") + env
...
if __name__ == "__main__":
    logger = Logger("ifttt.log", level="debug").logger
    main()
