...
# dog
# COIN_DOG = "0xba2ae424d960c26247dd6c32edc70b295c744c43"
# tdog
# COIN_TDOG = "0xe550a593d09fbc8dcd557b5c88cea6946a8b404a"

PIT_COIN = "0xba2ae424d960c26247dd6c32edc70b295c744c43"
PIT_COIN_T = "0xe550a593d09fbc8dcd557b5c88cea6946a8b404a"
...
def get_latest_coin_price(url, address, key):
    ...
    try:
        ...
        for item in result["data"]:
            if item["id"] == address + "-bsc":
                priceUSD = item["priceUSD"]
                break
        return (key, round(priceUSD, 3))
...
def post_ifttt_webhook(event, value1, value2):
    ...
    data = {"value1": value1 + date, "value2": value2}
...
def ifttt():
    ...
    while True:
        result = gevent.joinall([
            gevent.spawn(get_latest_coin_price,
                         SEARCH_ADDRESS.format(BTCST), BTCST, "BTCST"),
            gevent.spawn(get_latest_coin_price,
                         SEARCH_ADDRESS.format(BTC), BTC, "BTC"),
            gevent.spawn(get_latest_coin_price,
                         SEARCH_ADDRESS.format(TBTC), TBTC, "TBTC"),
            gevent.spawn(get_latest_coin_price,
                         SEARCH_ADDRESS.format(BNBTC), BNBTC, "BNBTC"),
            gevent.spawn(get_latest_coin_price, SEARCH_ADDRESS.format(
                PIT_COIN), PIT_COIN, "PIT_COIN"),
            gevent.spawn(get_latest_coin_price, SEARCH_ADDRESS.format(
                PIT_COIN_T), PIT_COIN_T, "PIT_COIN_T"),
        ])
        ...
        post_ifttt_webhook(EVENT_NAME, "©© BTCST ⛏️ ", format_coin(obj))
...
if __name__ == "__main__":
    logger = Logger("tmp.log", level="debug").logger
    main()
