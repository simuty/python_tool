...
sendIfttt({ name: "BNB", token: "0x17B7163cf1Dbd286E262ddc68b553D899B93f526", price: 1 })

export async function sendIfttt(args?: TYPE_TG_MSG) {
    const { name, token, price } = args;
